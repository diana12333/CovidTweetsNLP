...
train_data = pd.read_csv('/Users/dianshen/Library/Mobile Documents/com~apple~CloudDocs/20Fall/CompMethodsInformatics/Assignment/Final/Coronavirus tweets NLP - Text Classification/Corona_NLP_train.csv',encoding='latin_1')
train_data.head()
